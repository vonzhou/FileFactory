cient: sha1.o recipe.o rabin.o client.o backup.o wrapunix.o wrapsock.o  writen.o error.o
	gcc -o client  sha1.o recipe.o rabin.o client.o backup.o wrapunix.o writen.o error.o  wrapsock.o  -lssl -lcrypto
	@echo "Compiling ....\n"
